                      ...
                      RaisedButton(
                        onPressed: () async {
                          ...
                          if (categories.length > 0 && categories[0]['items'].length > 0) {
                            ...
                            await planningService.storePlanning(data).then((value) {
                              if (value) {
                                helpers.alert(scaffoldKey, "Planning added successfully.");
                                setState(() {
                                  title.text = "";
                                  categories = [];
                                });
                                ...
                                helpers.alert(scaffoldKey, "Error occurred, unable to add planning.");
                              }
                            });
                          } else {
